...
with open("C:/Users/shgtkmt/workspace\\X.txt", "r") as f:
    num=-1
    row=-1
    column=-1
    ch=0
...
with open("C:/Users/shgtkmt/workspace\\Xte.txt", "r") as f:
    num=-1
    row=-1
    column=-1
    ch=0
...
print(X[10,10,10,0],X[10,10,10,1],X[10,10,10,2],X[10,10,10,3])
print(Y[10,10,10])
...
img = Image.fromarray(Xte[5,:,:,0])
img.save('./demo/origin.png')
ans = model.predict_on_batch(Xte)
img = Image.fromarray(scaler.fit_transform(ans[5,:,:]))
img.save('./demo/result.png')
img = Image.fromarray(Yte[5,:,:])
img.save('./demo/answer.png')
'''